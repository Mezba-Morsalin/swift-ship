...
import CreateShipment from '@/app/components/dashboard/merchant/CreateShipment';
...
const MerchantCreateShipmentPage = async () => {
...
export default MerchantCreateShipmentPage;