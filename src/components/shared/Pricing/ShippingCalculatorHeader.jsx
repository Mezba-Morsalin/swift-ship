...
export default function ShippingCalculatorHeader() {
    ...
    <section className="relative w-full bg-slate-50/80 py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden border-b border-slate-200/60">
      ...
      <div className="relative max-w-7xl mx-auto">
        <motion.div
          ...
          className="flex flex-col items-start text-center mx-auto max-w-4xl"
        >
          {/* Top Pill Badge */}
  ...
  <span>TRANSPARENT SHIPPING CALCULATOR</span>
</div>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-[1.1] uppercase mb-5">
            SIMPLE FLAT RATES{" "}
            <span className="text-[#fcb915]">ZERO COD SURCHARGE</span>
          </h2>

          {/* Subtitle Paragraph */}
          <p className="text-sm sm:text-base md:text-lg text-slate-600 font-medium max-w-3xl mx-auto leading-relaxed">
            No hidden fees, no return penalties, and 0% commission on Cash on
            Delivery collections across all 64 districts in Bangladesh.
          </p>
        </motion.div>
      </div>
    </section>
